...
const ReduxTest = props => {
  ...
  const decrementCount = () => {
    //setCount(count - 1);
    props.actions.changeCount(count - 1);
    //console.log("decrement 1", count);
  };
...
const ReduxTESTHOC = connect(mapStateToProps, mapDispatchToProps)(ReduxTest);
